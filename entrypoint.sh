...
export NGINX_ERROR_LOG_LIMIT="${NGINX_ERROR_LOG_LIMIT:-1024}"
...
export NGINX_FASTCGI_BUFFERS_NUMBER="${NGINX_FASTCGI_BUFFERS_NUMBER:-256}"
export NGINX_FASTCGI_BUFFERS_SIZE="${NGINX_FASTCGI_BUFFERS_SIZE:-4k}"
