...
envsubst '${APPLICATION_ROOT},${PHP_VERSION},${PHP_POST_MAX_SIZE},${PHP_OPCACHE_ENABLE},${PHP_OPCACHE_MEMORY_CONSUMPTION},${PHP_OPCACHE_MAX_ACCELERATED_FILES},${PHP_OPCACHE_VALIDATE_TIMESTAMPS},${PHP_OPCACHE_REVALIDATE_FREQ},${PHP_OPCACHE_INTERNED_STRINGS_BUFFER},${PHP_OPCACHE_FAST_SHUTDOWN},${PHP_MEMORY_LIMIT},${PHP_UPLOAD_MAX_FILESIZE}' < /ops/files/php.ini.template > /usr/local/etc/php/php.ini
